...
noise = 1*10^(-3); %the noise strenght
...
%% xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    ...
    [sol,normF,lb,ub, AA] = calculations_nmf(number_of_sources,nd,Nsim,aa,xD,t0,time,S,numT);
    disp(size(sol));
...
[Solution, VectIndex, Cent, reconstr, mean_savg, number_of_clust_sim] = clustering_the_solutions(number_of_sources,nd,sol,normF);
